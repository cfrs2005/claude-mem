    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          // Zhipu Configuration
          CLAUDE_MEM_ZHIPU_API_KEY: data.CLAUDE_MEM_ZHIPU_API_KEY || DEFAULT_SETTINGS.CLAUDE_MEM_ZHIPU_API_KEY,
          CLAUDE_MEM_ZHIPU_MODEL: data.CLAUDE_MEM_ZHIPU_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_ZHIPU_MODEL,
