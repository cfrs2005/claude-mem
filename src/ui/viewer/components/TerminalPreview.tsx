    ...
    >
      ...
      >
        ...
        <button
          ...
          title={wordWrap ? t('terminalPreview.disableWrap') : t('terminalPreview.enableWrap')}
        >
          {wordWrap ? t('terminalPreview.wrap') : t('terminalPreview.scroll')}
        </button>
      </div>
